...
# Initialize wandb
# =====================
wandb.init(project="LiverTumor", name="UNetPlusPlus_Finetune")
...
checkpoint = ModelCheckpoint(
    "unetplusplus_finetune_best_model.h5",
    monitor="val_loss",
    save_best_only=True
)
...
# Save Final Model
# =====================
model.save("unetplusplus_finetune_final_model.h5")
