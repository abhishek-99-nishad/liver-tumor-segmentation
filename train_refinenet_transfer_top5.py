...
# Init wandb
wandb.init(project="LiverTumor", name="RefineNet_TransferLearning_Top5")
...
checkpoint = ModelCheckpoint("refinenet_transfer_top5_best_model.h5", monitor="val_loss", save_best_only=True)
...
model.save("refinenet_transfer_top5_final_model.h5")
wandb.finish()
