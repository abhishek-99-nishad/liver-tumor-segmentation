...
# Initialize wandb
# =====================
wandb.init(project="LiverTumor", name="ResUNet_Transfer")
...
# =====================
# Build ResUNet (Transfer mode → encoder frozen)
# =====================
model = build_resunet(trainable=False)
...
checkpoint = ModelCheckpoint(
    "resunet_transfer_best_model.h5",
    monitor='val_loss',
    save_best_only=True
)
...
history = model.fit(
    ...
    epochs=10,
    batch_size=8,   # safer for CPU (reduce to 4 if memory error)
...
# Save Final Model
# =====================
model.save("resunet_transfer_final_model.h5")
