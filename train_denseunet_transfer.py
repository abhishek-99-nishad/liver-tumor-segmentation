...
# Initialize wandb
# =====================
wandb.init(project="LiverTumor", name="DenseUNet_Transfer")
...
# Expand dims if needed (IMPORTANT)
...
checkpoint = ModelCheckpoint(
    "denseunet_transfer_best_model.h5",
    monitor='val_loss',
    save_best_only=True
)
...
# Save Final Model
# =====================
model.save("denseunet_transfer_final_model.h5")
