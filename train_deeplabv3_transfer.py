...
# Initialize wandb
# =====================
wandb.init(project="LiverTumor", name="DeepLabV3_Transfer")
...
# =====================
# Build DeepLabV3 (Frozen backbone)
# =====================
model = build_deeplabv3(input_shape=(256,256,1), trainable=False)
...
checkpoint = ModelCheckpoint(
    "deeplabv3_transfer_best_model.h5",
    monitor='val_loss',
    save_best_only=True
)
...
# Save Final Model
# =====================
model.save("deeplabv3_transfer_final_model.h5")
