...
# Init wandb
wandb.init(project="LiverTumor", name="RefineNet_FineTuning")
...
# Build model (fine-tune, encoder trainable)
model = build_refinenet(trainable=True)

# If you want, you can initialize from transfer model weights
model.load_weights("refinenet_transfer_best_model.h5")
...
checkpoint = ModelCheckpoint("refinenet_finetune_best_model.h5", monitor="val_loss", save_best_only=True)
...
model.save("refinenet_finetune_final_model.h5")
wandb.finish()
